...
def run_model(task=None, model_name=None, dataset_name=None, config_file=None,
              saved_model=True, train=True, other_args=None, method=None):
    ...
    if method == "test":
        ...
        executor.TENT(test_data)
    elif method == "TTT_MAE":
        executor.TTT_MAE(test_data)
    elif method == "ADCSD":
        executor.ADCSD(test_data)
    else:
        raise TypeError('No method provided!')
